...
datasets = ['ERN','MI', 'P300','MI_DR']
model_lists = {'ERN': ['EEGNet', 'DeepCNN'], 'MI': ['EEGNet', 'DeepCNN'],
               'P300': ['EEGNet', 'DeepCNN'],'MI_DR':['EEGNet', 'DeepCNN']}
amplitudes = { 'ERN': 0.2,'MI': 1.5, 'P300': 0.006,'MI_DR':0.3}
