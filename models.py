...
def DeepConvNet(nb_classes, Chans=64, Samples=256,
    ...
    block1 = Conv2D(25, (1, 5),
                    input_shape=(1, Chans, Samples),
                    kernel_constraint=max_norm(2., axis=(0, 1, 2)))(input_main)#25维的filter，长宽为1,5
...
def ShallowConvNet(nb_classes, Chans=64, Samples=128, is_denoising=False, dropoutRate=0.5):
    ...
    block1 = Conv2D(40, (1, 13),
                    input_shape=(1, Chans, Samples),#1才是常规意义上的channel，channelfirst，而后面的channel指脑机接口的channel
